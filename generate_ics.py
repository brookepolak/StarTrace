...
class SubClusters():
    ...
    def __init__(self, num_total,  num_subclusters, radius, subcluster_rho,
        ...
        Args:
            num_total (_type_): _description_
            num_subclusters (_type_): _description_
            radius (_type_): _description_
            subcluster_radii (_type_): _description_
            subcluster_virial_ratio (float, optional): _description_. Defaults to 0.1.
            global_virial_ratio (_type_, optional): _description_. Defaults to None.
            seed (int, optional): _description_. Defaults to 0.
            masses (float, optional): _description_. Defaults to 1.0.
            sample_IMF (bool, optional): _description_. Defaults to False.
            IMF_range (tuple, optional): _description_. Defaults to (0.08,20).
            G (float, optional): _description_. Defaults to pc^3/(Msun*Myr^2)
    ...
    def sample_uniform_sphere(self, n, r):
        ...
        This method was chosen because it is faster than the Gaussian method where
        normalizing the vector is expensive.
